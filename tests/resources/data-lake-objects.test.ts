...
import { DataLakeObjectsService } from "../../src/resources/data-lake-objects.js";
...
describe("DataLakeObjectsService", () => {
  it("list()", async () => {
    const httpClient = createMockHttpClient();
    const service = new DataLakeObjectsService(httpClient);
